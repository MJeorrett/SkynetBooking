...
{
    public static async Task<T?> ReadOptionalAppResponseContentAs<T>(this HttpResponseMessage message)
    {
        try
        {
    ...
    public static async Task<T> ReadAppResponseContentAs<T>(this HttpResponseMessage message)
    {
        var responseContent = await message.ReadOptionalAppResponseContentAs<T>();
